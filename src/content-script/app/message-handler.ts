...
export function validateConfigUpdate(update: Partial<TradingConfigV2>): ConfigValidationResult {
  ...
  if (sanitized.minPayout !== undefined) {
    if (typeof sanitized.minPayout !== 'number' || sanitized.minPayout < 0 || sanitized.minPayout > 100) {
  ...
  if (sanitized.maxDrawdown !== undefined) {
    if (typeof sanitized.maxDrawdown !== 'number' || sanitized.maxDrawdown < 0 || sanitized.maxDrawdown > 100) {
  ...
  if (sanitized.maxConsecutiveLosses !== undefined) {
    if (typeof sanitized.maxConsecutiveLosses !== 'number' || sanitized.maxConsecutiveLosses < 1 || sanitized.maxConsecutiveLosses > 100) {
