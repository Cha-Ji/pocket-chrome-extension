  ...
  private finalizeCandle(ticker: string, buffer: CandleBuffer): void {
    ...
    try {
      chrome.runtime
        ...
        .catch((e) => console.error('[CandleCollector] CANDLE_FINALIZED send error:', e));
    } catch (e) {
      console.error('[CandleCollector] CANDLE_FINALIZED send error:', e);
    }
