...
describe('analyzeByMonth', () => {
  ...
  it('should group trades by month correctly', () => {
    const trades: BacktestTrade[] = [
      createBacktestTrade(new Date('2024-01-15').getTime(), new Date('2024-01-15').getTime() + 60000, 'CALL', 'WIN', 92),
      createBacktestTrade(new Date('2024-01-20').getTime(), new Date('2024-01-20').getTime() + 60000, 'CALL', 'LOSS', -100),
      createBacktestTrade(new Date('2024-02-10').getTime(), new Date('2024-02-10').getTime() + 60000, 'CALL', 'WIN', 92),
    ]
  ...
  it('should calculate average profit correctly', () => {
    const trades: BacktestTrade[] = [
      createBacktestTrade(new Date('2024-03-01').getTime(), new Date('2024-03-01').getTime() + 60000, 'CALL', 'WIN', 100),
      createBacktestTrade(new Date('2024-03-15').getTime(), new Date('2024-03-15').getTime() + 60000, 'CALL', 'LOSS', -50),
    ]
