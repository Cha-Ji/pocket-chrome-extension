 ...
 */
export function generateSmallTestData(pattern: 'uptrend' | 'downtrend' | 'ranging' | 'volatile' = 'ranging', count: number = 200): Candle[] {
 ...
 */
export function generateMediumTestData(pattern: 'uptrend' | 'downtrend' | 'ranging' | 'volatile' = 'ranging', count: number = 500): Candle[] {
  return generatePatternedData(pattern, count)
}
