...
export { calculateScore, DEFAULT_SCORE_WEIGHTS, SCORING_THRESHOLDS } from './scoring';
export type { ScoreInput, ScoreResult, ScoreBreakdown, ScoreGrade, ScoreWeights } from './scoring';
export {
  RSIStrategies,
...
export function initializeBacktest(): void {
  ...
  const totalStrategies =
    RSIStrategies.length +
    SMMAStrategies.length +
    CCIStrategies.length +
    WilliamsRStrategies.length;
