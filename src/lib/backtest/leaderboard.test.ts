...
describe('Leaderboard', () => {
  ...
  describe('scoreAndRankEntries', () => {
    ...
    it('should rank higher win rate strategy first', () => {
      const entries: LeaderboardEntry[] = [
        makeMockEntry('low', { winRate: 45, profitFactor: 0.8, maxDrawdownPercent: 20, maxConsecutiveLosses: 8, tradesPerDay: 5, recoveryFactor: 0.5 }),
        makeMockEntry('high', { winRate: 60, profitFactor: 2.0, maxDrawdownPercent: 5, maxConsecutiveLosses: 3, tradesPerDay: 10, recoveryFactor: 3.0 }),
      ]
      scoreAndRankEntries(entries)
