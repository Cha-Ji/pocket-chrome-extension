...
describe('PocketOptionDetector', () => {
  ...
  it('should give higher score when URL contains demo', () => {
    const demoScore = detector.detect(
      'https://pocketoption.com/demo',
      document,
    )
    const liveScore = detector.detect(
      'https://pocketoption.com/live',
      document,
    )
  ...
  it('should give higher score when DOM contains PO elements', () => {
    // DOM 없이
    const scoreNoDom = detector.detect(
    ...
    const scoreWithDom = detector.detect(
      'https://pocketoption.com/',
      document,
    )
  ...
  it('should give maximum score for demo URL + DOM elements', () => {
    ...
    const score = detector.detect(
      'https://pocketoption.com/demo-quick-high-low',
      document,
    )
